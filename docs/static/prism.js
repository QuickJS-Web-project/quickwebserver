/* PrismJS 1.23.0
https://prismjs.com/download.html#themes=prism-okaidia&languages=markup+css+clike+javascript+bash&plugins=line-highlight */
var _self =
    ...
    Prism.hooks.add('before-sanity-check', function (e) {
      ...
      Prism.hooks.add('complete', function e(t) {
        ...
        if (n && i && /pre/i.test(n.nodeName)) {
          ...
          if (y(n, 'line-numbers') && r && !o) Prism.hooks.add('line-numbers', e);
    ...
    if (t && !document.getElementById(e)) {
      ...
      if (i)
        i.hasAttribute('data-line') || i.setAttribute('data-line', ''),
          l(i, t, 'temporary ')(),
          b && document.querySelector('.temporary.line-highlight').scrollIntoView();
    }
  }
})();
